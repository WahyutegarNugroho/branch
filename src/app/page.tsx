            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                ...
                <div className="space-y-3 max-w-lg">
                  <form action="/register" method="get" className="flex flex-col sm:flex-row gap-2.5">
                    ...
                    <div className="flex flex-1 items-center bg-zinc-900/90 border border-zinc-700/80 rounded-xl overflow-hidden focus-within:border-emerald-400 focus-within:ring-2 focus-within:ring-emerald-400/20 transition-all shadow-inner">
                      <span className="pl-3.5 text-zinc-400 font-mono text-sm select-none" aria-hidden="true">
                        branch.bio/
                      </span>
                      <input
                        id="hero-username"
                        ...
                        className="w-full h-12 px-2 bg-transparent text-white font-medium text-sm placeholder:text-zinc-500 focus:outline-none"
                      />
                    </div>
                    <button
                      type="submit"
                      className="h-12 px-6 rounded-xl bg-white hover:bg-zinc-100 text-zinc-950 font-bold text-sm transition-all shadow-[0_1px_3px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.8)] flex items-center justify-center whitespace-nowrap active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white cursor-pointer"
                    >
                      Claim your link
                    </button>
                  </form>
                ...
                <div className="pt-6 border-t border-white/[0.08] grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-xl">
                  <div>
                    <p className="text-xl sm:text-2xl font-bold text-white tracking-tight font-heading">Unlimited</p>
                    <p className="text-xs text-zinc-300 mt-0.5">Links & embeds</p>
                  </div>
                  <div>
                    <p className="text-xl sm:text-2xl font-bold text-white tracking-tight font-heading">6 Styles</p>
                    <p className="text-xs text-zinc-300 mt-0.5">WebGL backgrounds</p>
                  </div>
                  <div>
                    <p className="text-xl sm:text-2xl font-bold text-white tracking-tight font-heading">0 Cookies</p>
                    <p className="text-xs text-zinc-300 mt-0.5">First-party stats</p>
                  </div>
                  <div>
                    <p className="text-xl sm:text-2xl font-bold text-emerald-400 tracking-tight font-heading">Zero</p>
                    <p className="text-xs text-zinc-300 mt-0.5">Forced watermarks</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto rounded-3xl bg-zinc-900/90 border border-white/[0.08] p-8 sm:p-14 text-center relative overflow-hidden">
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="/register"
                  className="h-12 px-8 rounded-xl bg-white hover:bg-zinc-100 text-zinc-950 font-bold text-sm transition-all shadow-md flex items-center justify-center whitespace-nowrap active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white cursor-pointer"
                >
                  Create your free page
                </Link>
                <Link
                  href="/login"
                  className="h-12 px-6 rounded-xl bg-zinc-950 hover:bg-zinc-800 text-zinc-200 hover:text-white font-medium text-sm border border-zinc-700 transition-all flex items-center justify-center whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white cursor-pointer"
                >
                  Sign in
                </Link>
              </div>
