...
export const buttonShapeEnum = z.enum(['rounded-none', 'rounded-xl', 'rounded-3xl', 'rounded-full', 'rounded-2xl'])

export const buttonStyleEnum = z.enum(['fill', 'outline', 'soft', 'shadow'])

export const fontFamilyEnum = z.enum(['font-sans-theme', 'font-display-theme', 'font-serif-theme', 'font-mono-theme'])
...
export const profileAlignEnum = z.enum(['center', 'left'])
